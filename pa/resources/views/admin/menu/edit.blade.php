            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header text-center">
                        <h2 class="mb-0">Ubah Data Menu Makan</h2>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ url('controlerny') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="nama">Nama Menu Makan:</label>
                                <div class="input-group input-group-merge">
                            ...
                            <div class="d-grid gap-2 mb-3">
                                <button class="btn btn-primary" type="button">Ubah Menu Makan</button>
                            </div>
                        </form>
                    </div>
                </div>
